...
!function() {
    ...
    function _(t, ...i) {
        for (const s of i)
            for (const i in s)
                void 0 !== s[i] && Object.prototype.hasOwnProperty.call(s, i) && !["__proto__", "constructor", "prototype"].includes(i) && ("object" != typeof s[i] || void 0 === t[i] || Array.isArray(s[i]) ? t[i] = s[i] : _(t[i], s[i]));
        return t
    }
    function u(t) {
    ...
    function p(t) {
        ...
        if (!i || "object" != typeof i)
            return i;
        let s, n, e;
        for (n in s = Array.isArray(i) ? [] : {},
        i)
            i.hasOwnProperty(n) && (e = i[n],
            s[n] = e && "object" == typeof e ? p(e) : e);
        return s
    }
    function v(t) {
        return null !== t
    ...
    class S {
        ...
        tt(t, i, s) {
            const [n,e,r,h] = this.K(t)
              , [a,l,o,_] = this.K(i)
              , u = [b(n + s * (a - n)), b(e + s * (l - e)), b(r + s * (o - r)), (c = h + s * (_ - h),
              ...
              , h = h => {
                ...
                for (let a = n.to - 1; a >= n.from; --a) {
                    const n = e.ot[a]
                      ...
                      , _ = h * s + r;
                    t.moveTo(l, o),
                    t.arc(l, o, _, 0, 2 * Math.PI)
                }
                t.fill()
            }
            ;
            e.ct > 0 && (t.fillStyle = e.dt,
            h(e.ft + e.ct)),
            t.fillStyle = e.vt,
            h(e.ft)
        }
    ...
    class R {
        ...
        Tt() {
            return this.St && (this.Rt(),
            this.St = !1),
            this.Mt
        }
        kt() {
            const t = this.Pt.Dt();
            t.length !== this.bt.length && (this.xt = t.map(k),
        ...
        Rt() {
            ...
            i.forEach(( (i, e) => {
                const r = this.xt[e]
                  , h = i.At(s)
                  , a = i.zt();
                !t && null !== h && i.Et() && null !== a ? (r.vt = h.Ot,
                r.ft = h.ft,
                r.ct = h.Lt,
                r.ot[0].gt = h.gt,
    ...
    class D extends P {
        ...
        et({context: t, bitmapSize: i, horizontalPixelRatio: s, verticalPixelRatio: r}) {
            ...
            t.lineCap = "butt",
            h && l >= 0 && (t.lineWidth = Math.floor(this.qt.Yt.ct * s),
            ...
            a && o >= 0 && (t.lineWidth = Math.floor(this.qt.Kt.ct * r),
    ...
    function I(t, i, s, n, e, r) {
        t.beginPath(),
        t.roundRect ? t.roundRect(i, s, n, e, r) : (t.lineTo(i + n - r[1], s),
    ...
    function A(t, i, s, n, e, r, h=0, a=[0, 0, 0, 0], l="") {
        if (t.save(),
        !h || !l || l === r)
            return I(t, i, s, n, e, a),
            t.fillStyle = r,
            t.fill(),
            void t.restore();
        const o = h / 2;
        var _;
        I(t, i + o, s + o, n - h, e - h, (_ = -o,
        a.map((t => 0 === t ? t : t + _)))),
        "transparent" !== r && (t.fillStyle = r,
        t.fill()),
        "transparent" !== l && (t.lineWidth = h,
        t.strokeStyle = l,
        t.closePath(),
        t.stroke()),
        t.restore()
    ...
    class O {
        ...
        nt(t, i, s, n) {
            if (!this.qt.Et || 0 === this.qt.ri.length)
                return;
            const e = this.qt.R
              , r = this.ei.Z
              , h = t.useBitmapCoordinateSpace((t => {
                ...
                const a = this.hi(t, i, s, n)
                  , l = a.ai;
                return a.li ? A(h, l.oi, l._i, l.ui, l.ci, r, l.di, [l.ft, 0, 0, l.ft], r) : A(h, l.fi, l._i, l.ui, l.ci, r, l.di, [0, l.ft, l.ft, 0], r),
                this.qt.pi && (h.fillStyle = e,
                h.fillRect(l.fi, l.mi, l.wi - l.fi, l.gi)),
                this.qt.Mi && (h.fillStyle = i.D,
        ...
        hi(t, i, s, n) {
            const {context: e, bitmapSize: r, mediaSize: h, horizontalPixelRatio: a, verticalPixelRatio: l} = t
    ...
    class N extends L {
        ...
        ji(t, i, s) {
            ...
            if (!n.labelVisible)
                return;
            const e = this.qi.zt();
            if (!this.Jt.Et() || this.qi.Ki() || null === e)
                return;
    ...
    class F {
        ...
        nt(t, i) {
            if (null === this.qt || !1 === this.qt.Et || 0 === this.qt.ri.length)
                return;
            const s = t.useMediaCoordinateSpace(( ({context: t}) => (t.font = i.k,
            Math.round(i.Gi.Ei(t, a(this.qt).ri, W)))));
            if (s <= 0)
                return;
            const n = i.Ji
              , e = s + 2 * n
            ...
            let l = this.qt.Bi
              , o = Math.floor(l - r) + .5;
            o < 0 ? (l += Math.abs(0 - o),
            o = Math.floor(l - r) + .5) : o + e > h && (l -= Math.abs(h - (o + e)),
            o = Math.floor(l - r) + .5);
            const _ = o + e
    ...
    class j extends U {
        ...
        Ws(t) {
            ...
            this.gs.set(t, i));
            let s = this.Ms.get(t);
            return s || (s = new R(this.ts,this,t),
            this.Ms.set(t, s)),
            [i, s]
        }
        ti(t) {
        ...
        Fs(t, i) {
            ...
            const s = [];
            return this.Pt === t && s.push(this.Hs(this.vs, i, this.ys)),
            s
        }
        cs() {
        ...
        qs(t, i, s) {
            ...
            return null !== l && null !== o ? (this.ds = i,
            this.xs = l.Nt(i, o)) : (this.ds = NaN,
            this.xs = NaN),
        ...
        Hs(t, i, s) {
            let n = t.get(i);
            return void 0 === n && (n = new N(this,i,s),
            t.set(i, n)),
            n
        }
    }
    ...
    class Q extends K {
        ...
        format(t) {
            ...
            return t < 0 && (i = "-",
            t = -t),
            t < 995 ? i + this.Pn(t) : t < 999995 ? i + this.Pn(t / 1e3) + "K" : t < 999999995 ? (t = 1e3 * Math.round(t / 1e3),
            i + this.Pn(t / 1e6) + "M") : (t = 1e6 * Math.round(t / 1e6),
            i + this.Pn(t / 1e9) + "B")
        }
        Pn(t) {
            let i;
            const s = Math.pow(10, this.Cn);
            return i = (t = Math.round(t * s) / s) >= 1e-15 && t < 1 ? t.toFixed(this.Cn).replace(/\.?0+$/, "") : String(t),
    ...
    class it {
        ...
        Bn(t, i, s) {
            ...
            if (this.Dn.has(e))
                return h(this.Dn.get(e)).In;
            if (this.yn === this.En) {
                const t = this.Rn[this.Tn];
                delete this.Rn[this.Tn],
                this.Dn.delete(t),
                this.Tn++,
                this.yn--
            }
            ...
            return t.restore(),
            0 === r.width && i.length || (this.Dn.set(e, {
                In: r,
                An: this.kn
            }),
            this.Rn[this.kn] = e,
    ...
    class rt {
        ...
        Tt() {
            return this.Jn.Et() ? (this.St && (this.te(),
            this.St = !1),
            this.Gn) : null
        }
    }
    class ht extends rt {
        ...
        te() {
            ...
            if (2 !== i && 3 !== i)
                return;
            const s = this.Jn.N();
            if (!s.baseLineVisible || !this.Jn.Et())
                return;
            const n = this.Jn.zt();
            null !== n && (this.Zn.Et = !0,
    ...
    class ot {
        ...
        be() {
            if (this.yt(),
            2 === this.ge.N().lastPriceAnimation) {
                const t = performance.now()
                  , i = this.we - t;
                if (i > 0)
                    return void (i < 650 && (this.we += 2600));
                this.me = t,
                this.we = t + 2600
            }
        }
    ...
    class _t extends rt {
        ...
        te() {
            ...
            t.Et = !1;
            const i = this.Jn.N();
            if (!i.priceLineVisible || !this.Jn.Et())
                return;
    ...
    class ut extends L {
        ...
        ji(t, i, s) {
            ...
            if (l.ke)
                return;
            r && (t.ri = this.Ae(l, r, a),
            t.Et = 0 !== t.ri.length),
            (h || a) && (i.ri = this.ze(l, r, h, a),
            i.Et = i.ri.length > 0);
            const o = n.Be(l.R)
              , _ = this.Jt.Qt().Xi().X(o);
            s.Z = _.Z,
    ...
    class yt {
        ...
        Yr(t) {
            let i = this.Xr(t);
            return i > 0 && (i -= 1),
            i !== this.Er.length && this.Lr(i) < t ? i : null
        }
        Kr(t) {
            const i = this.Zr(t);
    ...
    class Ut extends wt {
        ...
        ye(t) {
            const i = {
              ...
              , s = this.Wt();
            if (this.Qt().It().Ki() || s.Ki() || this.qt.Ki())
                return i;
        ...
        Rh() {
            return null !== this.Ch || (this.Ch = new Mt(this)),
            this.Ch
        }
        N() {
            return this.Ps
        ...
        Lh(t) {
            ...
            return this.bh.push(i),
            this.Qt().Ih(this),
            i
        }
        Nh(t) {
            const i = this.bh.indexOf(t);
            -1 !== i && this.bh.splice(i, 1),
            this.Qt().Ih(this)
        }
        Wh() {
            return this.bh
        ...
        Ws() {
            const t = [];
            this.Gh() || t.push(this.xh),
            t.push(this.sh, this.er);
            const i = this.bh.map((t => t.lr()));
            return t.push(...i),
            Lt(this.yh, Nt, "normal", t),
            t
        }
        Jh() {
        ...
        Fs(t, i) {
            if (i !== this.es && !this.Gh())
                return [];
            const s = [...this.vs];
            for (const t of this.bh)
                s.push(t.ur());
        ...
        Ns() {
            ...
            this.xh.yt(),
            this.Sh?.yt(),
            this.yh.forEach((t => t.Ns()))
        }
        Wt() {
            return a(super.Wt())
        }
        At(t) {
            if (!(("Line" === this.kh || "Area" === this.kh || "Baseline" === this.kh) && this.Ps.crosshairMarkerVisible))
                return null;
            const i = this.qt.kr(t);
            if (null === i)
                return null;
        ...
        da() {
            if ("Custom" === this.kh)
                return t => this.sh.fa(t)
        }
        pa() {
            if ("Custom" === this.kh)
                return t => this.sh.va(t)
        }
        ma() {
            return this.qt.jr()
        }
        ...
        Oa(t, i, s) {
            ...
            for (; ; ) {
                ...
                if (!(t && i && a))
                    break;
                e /= h,
                h = this.Aa[++r % this.Aa.length]
            }
            if (e <= n + 1e-14 && (e = n),
            e = Math.max(1, e),
            this.za.length > 0 && (a = e,
            l = 1,
            o = 1e-14,
            Math.abs(a - l) < o))
                for (r = 0,
                h = this.za[0]; Kt(e, s * h, 1e-14) && e > n + 1e-14; )
                    e /= h,
                    h = this.za[++r % this.za.length];
            var a, l, o;
            return e
        }
    }
    class _i {
        ...
        Ha() {
            ...
            const u = this.La.map((t => t.Xa))
              , c = this.qi.Za(u);
            for (let t = 0; t < this.La.length; t++)
                this.La[t].Ga = c[t]
        }
        Ea() {
            return this.La
        ...
        $a(t, i, s, n, e, r) {
            ...
            for (let c = s - l; c > n; c -= i) {
                ...
                null !== _ && Math.abs(s - _) < this.Fa() || (s < e || s > r || (u < h.length ? (h[u].ya = s,
                h[u].Ga = a.Ja(c),
                h[u].Xa = c) : h.push({
                    ya: s,
                    Ga: a.Ja(c),
        ...
        qa(t, i, s) {
            let n = l(this.qi.Qe());
            return this.qi.Qa() && (n = ai(n, this.qi.il())),
            n.$e() - i < t && s - n.je() < t
        }
    }
    function ui(t) {
    ...
    class pi {
        ...
        kl(t) {
            ...
            void 0 !== t.ie && (this.Ps.mode = t.ie,
            2 !== t.ie && 3 !== t.ie || (this.Ps.autoScale = !0),
            this.rl.hl = !1),
            1 === i.ie && t.ie !== i.ie && (!function(t, i) {
                if (null === t)
                    return !1;
                const s = ri(t.$e(), i)
                  , n = ri(t.je(), i);
                return isFinite(s) && isFinite(n)
            }(this.Ge, this.gl) ? this.Ps.autoScale = !0 : (s = ai(this.Ge, this.gl),
            null !== s && this.Bl(s))),
            1 === t.ie && t.ie !== i.ie && (s = hi(this.Ge, this.gl),
            null !== s && this.Bl(s));
            const n = i.ie !== this.Ps.mode;
            n && (2 === i.ie || this.Oe()) && this.ga(),
            n && (3 === i.ie || this.El()) && this.ga(),
            void 0 !== t.Vl && i.Vl !== t.Vl && (this.Ps.invertScale = t.Vl,
            this.Il()),
            this.cl.p(i, this.ie())
        }
        Al() {
        ...
        Bl(t, i) {
            const s = this.Ge;
            (i || null === s && null !== t || null !== s && !s.He(t)) && (this.vl = null,
            this.Ge = t)
        }
        Fl(t) {
            this.Bl(t),
        ...
        Ki() {
            return this.Wl(),
            0 === this.sl || !this.Ge || this.Ge.Ki()
        }
        Ul(t) {
            return this.Vl() ? t : this.$t() - 1 - t
        }
        Nt(t, i) {
            return this.Oe() ? t = ti(t, i) : this.El() && (t = si(t, i)),
            this.yl(t, i)
        }
        $l(t, i, s) {
            this.Wl();
        ...
        Dt() {
            return this.pl || (this.pl = ui(this.dl)),
            this.pl
        }
        Jl(t) {
            -1 === this.dl.indexOf(t) && (this.dl.push(t),
            this.ga(),
            this.Ql())
        }
        io(t) {
        ...
        Ea() {
            ...
            if (null !== this.vl && (t || this.vl.so === t))
                return this.vl.Ea;
            this.Cl.Ha();
            const i = this.Cl.Ea();
            return this.vl = {
        ...
        eo(t) {
            this.Oe() || this.El() || null === this.ml && null === this.el && (this.Ki() || (this.ml = this.sl - t,
            this.el = a(this.Qe()).Ue()))
        }
        ro(t) {
            if (this.Oe() || this.El())
                return;
        ...
        ho() {
            this.Oe() || this.El() || (this.ml = null,
            this.el = null)
        }
        ao(t) {
            this.Rl() || null === this.wl && null === this.el && (this.Ki() || (this.wl = t,
            this.el = a(this.Qe()).Ue()))
        }
        lo(t) {
            if (this.Rl())
        ...
        oo() {
            this.Rl() || null !== this.wl && (this.wl = null,
            this.el = null)
        }
        ra() {
        ...
        ga() {
            ...
            this.ha = fi,
            this.Oe() ? (this.ha = di,
            i = 100) : this.El() ? (this.ha = new G(100,1),
            i = 100) : null !== this.fl && (this.ha = this.fl.ra()),
        ...
        po() {
            ...
            for (const r of s) {
                ...
                if (null !== l) {
                    ...
                    if (i = null === i ? l : i.vn(a(l)),
                    null !== h) {
                        const t = h.tr();
                        null !== t && (n = Math.max(n, t.above),
                        e = Math.max(e, t.below))
                    }
                }
            }
            if (this.ja() && (n = Math.max(n, this.Ya()),
            e = Math.max(e, this.Ya())),
            n === this.ol && e === this._l || (this.ol = n,
            this._l = e,
            this.vl = null,
            this.Tl()),
            null !== i) {
                ...
                if (this.Qa()) {
                    ...
                    r.Va !== h.Va || r.Ba !== h.Ba) {
                        ...
                        this.gl = s,
                        i = hi(t, s),
                        null !== n && (this.el = hi(n, s))
                    }
                }
                this.Bl(i)
            } else
                null === this.Ge && (this.Bl(new dt(-.5,.5)),
                this.gl = li(null));
            var r, h
        }
        jl() {
        ...
        vo(t, i, s) {
            return void 0 === i ? (void 0 === s && (s = this.ra()),
            s.format(t)) : i(t)
        }
        mo(t, i, s) {
            return void 0 === i ? (void 0 === s && (s = this.ra()),
    ...
    class mi {
        ...
        io(t, i) {
            ...
            if (this.wo.has(n)) {
                const i = h(this.wo.get(n))
                  , s = i.indexOf(t);
                -1 !== s && (i.splice(s, 1),
                0 === i.length && this.wo.delete(n))
            }
            const e = t.Wt();
            e && e.ba().indexOf(t) >= 0 && (e.io(t),
            this.Wo(e)),
            this.pl = null
        }
        jn(t) {
        ...
        ks() {
            let t = null;
            return this.ts.N().rightPriceScale.visible && 0 !== this.ko.ba().length ? t = this.ko : this.ts.N().leftPriceScale.visible && 0 !== this.Po.ba().length ? t = this.Po : 0 !== this.dl.length && (t = this.dl[0].Wt()),
            null === t && (t = this.ko),
            t
        }
        $n() {
            let t = null;
            return this.ts.N().rightPriceScale.visible ? t = this.ko : this.ts.N().leftPriceScale.visible && (t = this.Po),
            t
        }
        Wo(t) {
        ...
        Dt() {
            return null === this.pl && (this.pl = ui(this.dl)),
            this.pl
        }
        Qo(t, i) {
            ...
            this.pl = null;
            for (const t of [this.Po, this.ko])
                t.Ql(),
                t.ga();
            this.ts.ar()
        }
        ...
        No(t, i, s) {
            let n = this.Do(i);
            if (null === n && (n = this.yo(i, this.ts.N().overlayPriceScales)),
          ...
          , e = function(t, i, s) {
            ...
            for (const a of t) {
                ...
                for (const i of t)
                    r = i.zOrder,
                    h = n?.zOrder,
                    (!h || "top" === r && "top" !== h || "normal" === r && "bottom" === h) && (n = i,
                    e = a)
            }
            var r, h;
            return n && e ? {
    ...
    class Ti {
        ...
        hr(t, i) {
            ...
            void 0 === t.minBarSpacing && void 0 === t.maxBarSpacing || this.ts.dn(t.barSpacing ?? this.j_),
            void 0 !== t.ignoreWhitespaceIndices && t.ignoreWhitespaceIndices !== this.Ps.ignoreWhitespaceIndices && this.Y_(),
            this.X_(),
            this.q_(),
            this.O_.p()
        }
        ...
        Io(t) {
            ...
            if (this.Ps.fixLeftEdge && null !== i && i.Uh() <= 0) {
                const i = s - t;
                this.U_ -= Math.round(i / this.j_) + 1,
                this.I_ = !0
            }
            this.au(),
            this.lu()
        ...
        Ea() {
            ...
            for (const t of h) {
                ...
                this.H_.push(s)),
                this.j_ > i / 2 && !_ ? s.needAlignCoordinate = !1 : s.needAlignCoordinate = u && t.index <= l || c && t.index >= o,
                d++
            }
            return this.H_.length = d,
            this.N_ = this.H_,
            this.H_
        }
        bu() {
            this.I_ = !0,
            this.dn(this.Ps.barSpacing),
            this.fn(this.Ps.rightOffset)
        }
        xu(t) {
            this.I_ = !0,
            this.R_ = t,
        ...
        eo(t) {
            this.wl && this.oo(),
            null === this.ml && null === this.L_ && (this.Ki() || (this.ml = t,
            this.Cu()))
        }
        ro(t) {
            if (null === this.L_)
        ...
        ho() {
            null !== this.ml && (this.ml = null,
            this.Pu())
        }
        ao(t) {
            null === this.wl && null === this.L_ && (this.Ki() || (this.wl = t,
            this.Cu()))
        }
        lo(t) {
            if (null === this.wl)
            ...
            this.U_ = a(this.L_).wu + i,
            this.I_ = !0,
            this.lu()
        }
        oo() {
            null !== this.wl && (this.wl = null,
            this.Pu())
        }
        yu() {
        ...
        Mu(t) {
            ...
            return void 0 === i && (i = new xi((t => this.Uu(t)),this.o_),
            this.V_.set(t.weight, i)),
            i.__(t)
        }
        Uu(t) {
    ...
    class Ii {
        ...
        ac(t) {
            if (this.qu?.n_ === t?.n_ && this.qu?.e_?.Kn === t?.e_?.Kn)
                return;
            const i = this.qu;
            this.qu = t,
            null !== i && this.Ih(i.n_),
        ...
        dc(t) {
            1 !== this.$u.length && (r(t >= 0 && t < this.$u.length, "Invalid pane index"),
            this.$u.splice(t, 1),
            this.Bh())
        }
        fc(t, i) {
        ...
        mc(t, i) {
            if (r(t >= 0 && t < this.$u.length && i >= 0 && i < this.$u.length, "Invalid pane index"),
            t === i)
                return;
        ...
        Qu(t) {
            return r(t >= 0, "Index should be greater or equal to 0"),
    ...
    var ss = function() {
        function t(t, i, s) {
            ...
            ,
            this._allowResizeObserver = null === (n = null == s ? void 0 : s.allowResizeObserver) || void 0 === n || n,
        ...
        t.prototype._resizeBitmap = function(t) {
            ...
            ts(i, t) || (this.canvasElement.width = t.width,
        ...
        t.prototype._suggestNewBitmapSize = function(t) {
            ...
            null === i && null === n || null !== i && null !== n && ts(i, n) || (this._suggestedBitmapSize = n,
    ...
    class us {
            ...
            this.Ld = t => {
                if (this.Nd(t)) {
                    ...
                    this.dd && this.ud > 1) {
                        ...
                        s < 30 && !this.bd && this.Ud(i, this.jd.$d),
                        this.qd()
                    }
                } else {
                    const i = this.Wd(t);
                    ...
                    this.od && this.ld > 1) {
                        ...
                        s < 5 && !this.Md && this.Yd(i, this.jd.Kd),
                        this.Xd()
                    }
                }
            }
        ...
        m() {
            null !== this.xd && (this.xd(),
            this.xd = null),
            null !== this.Sd && (this.Sd(),
            this.Sd = null),
            null !== this.Pd && (this.Pd(),
            this.Pd = null),
            null !== this.yd && (this.yd(),
            this.yd = null),
            null !== this.kd && (this.kd(),
            this.kd = null),
            null !== this.Cd && (this.Cd(),
            this.Cd = null),
            this.Jd(),
            this.Xd()
        }
        ...
        tf(t) {
            if (this.Vd || null !== this.wd)
                return;
            if (this.Nd(t))
                return;
            const i = this.Wd(t);
            this.Yd(i, this.jd.sf),
            this.Ad = !0
        }
        nf(t) {
        ...
        cf(t) {
            ...
            this.kd = null);
            const s = this.Wd(t, i);
            if (this.Ud(s, this.jd.df),
            ++this.ud,
            this.dd && this.ud > 1) {
                const {Fd: t} = this.Hd(fs(i), this.fd);
                t < 30 && !this.bd && this.Ud(s, this.jd.$d),
                this.qd()
            } else
                this.bd || (this.Ud(s, this.jd.ff),
                this.jd.ff && ds(t));
            0 === this.ud && ds(t),
            0 === t.touches.length && this.vd && (this.vd = !1,
            ds(t))
        }
        Od(t) {
            if (0 !== t.button)
            ...
            if (!this.Nd(t))
                ...
                this.od && this.ld > 1) {
                    ...
                    this.Md || this.Yd(i, this.jd.vf)
        }
        Jd() {
            null !== this.pd && (clearTimeout(this.pd),
            this.pd = null)
        }
        mf(t) {
            if (null !== this.Id)
        ...
        Gd() {
            ...
            this.Cf(),
            this.Zd.addEventListener("touchmove", ( () => {}
            ), {
                passive: !1
            })
        }
        ...
        Rf() {
            null !== this.Td && (this.Td = null,
            void 0 !== this.jd.kf && this.jd.kf())
        }
        Sf(t) {
            if (this.Pd && this.Pd(),
            this.Nd(t))
    ...
    class ms {
        ...
        yt() {
            this.Yf(),
            this.Ff.N().layout.panes.enableResize !== this.Nf && (this.Nf = this.Ff.N().layout.panes.enableResize,
            this.Nf ? this.Kf() : (null !== this.Of && (this.qf.removeChild(this.Of.Qf),
        ...
        rp(t) {
            null !== this.Wf && null !== this.Of && (this.Wf = null,
            this.Of.Qf.style.display = "none")
        }
    }
    function ws(t, i) {
        return t.dp - i.dp
    ...
    class Ms {
        ...
        Cp(t, i) {
            if (null !== this.fp) {
                if (this.fp.wt === i)
                    return void (this.fp.dp = t);
                if (Math.abs(this.fp.dp - t) < this.Mn)
                    return
            }
            this.mp = this.vp,
            this.vp = this.pp,
    ...
    class bs {
        ...
        Ep() {
            this.Bp() && (this.Vp(),
            this.ps = this.Ip(),
            this.ps && (this.Tp = this.Ap(),
            /*
            this.kp = document.createElement("style"),
            this.kp.innerText = "a#tv-attr-logo{--fill:#131722;--stroke:#fff;position:absolute;left:10px;bottom:10px;height:19px;width:35px;margin:0;padding:0;border:0;z-index:3;}a#tv-attr-logo[data-dark]{--fill:#D1D4DC;--stroke:#131722;}",
            ...
            */
            ...
            this.addDiv.id = 'actionBar',
            this.addDiv.style = '--fill:#131722;--stroke:#fff;position:absolute;left:10px;top:10px;height:19px;width:100%;margin:0;padding:0;border:0;z-index:3;',
            this.Rp.appendChild(this.addDiv)
    ...
    function xs(t, i) {
        ...
        var e;
        return n.resizeCanvasElement(i),
        n
    }
    function Ss(t) {
        t.width = 1,
    ...
    class Rs {
        ...
        rv(t) {
            null !== this.Op && ts(this.Op, t) || (this.Op = t,
            this.Hp = !0,
        ...
        _s(t) {
            this.qi !== t && (null !== this.qi && this.qi.no().u(this),
            this.qi = t,
        ...
        _v({context: t, bitmapSize: i, horizontalPixelRatio: s}) {
            ...
            let e;
            e = this.qp ? i.width - n : 0,
            t.fillRect(e, 0, n, i.height)
        }
        cv(t) {
            if (null === this.Op || null === this.qi)
                return;
            const i = this.qi.Ea()
              , s = this.qi.N()
              , n = this.iv()
        ...
        vv(t, i, s) {
            ...
            Ts(n, 1, this.Op.height, i),
            Ts(e, -1, this.Op.height, i)
        }
        dv(t) {
            if (null === this.Op)
                return;
    ...
    class Is {
        ...
        zv(t) {
            ...
            this.Av(),
            this.Dp.Uf().indexOf(this) === this.Dp.Uf().length - 1 ? (this.gv = this.gv ?? new bs(this.Vv,this.Dp),
            this.gv.yt()) : (this.gv?.Vp(),
            this.gv = null)
        }
        $p() {
            return this.Dp
        ...
        Lv() {
            null !== this.mv && this.mv.yt(),
            null !== this.wv && this.wv.yt()
        }
        Vo() {
        ...
        yf(t, i) {
            if (!this.Dp.N().handleScale.pinch)
                return;
            const s = 5 * (i - this.Cv);
            this.Cv = i,
            this.ts().Mc(t._t, s)
        ...
        Ov() {
            ...
            i || null === this.mv || (this.Bv.removeChild(this.mv.Xf()),
            this.mv.m(),
            this.mv = null),
            s || null === this.wv || (this.Iv.removeChild(this.wv.Xf()),
            this.wv.m(),
            this.wv = null);
            const n = t.Qt().Ec();
            i && null === this.mv && (this.mv = new Rs(this,t.N(),n,"left"),
            this.Bv.appendChild(this.mv.Xf())),
            s && null === this.wv && (this.wv = new Rs(this,t.N(),n,"right"),
        ...
        $v(t) {
            ...
            null !== this.Mv && !this.bv && (this.Mv.x !== t.clientX || this.Mv.y !== t.clientY)) {
                if (t.Bf && r.touch || !t.Bf && r.mouse) {
                    const t = s.vu();
                    this.Rv = new Ms(.2 / t,7 / t,.997,15 / t),
                    this.Rv.Cp(s.wu(), this.Mv.ed)
                } else
                    this.Rv = null;
                h.Ki() || i.qo(this.Dv, h, t.localY),
                i.xc(t.localX),
                this.bv = !0
            }
            this.bv && (h.Ki() || i.Yo(this.Dv, h, t.localY),
            i.Sc(t.localX),
    ...
    class As {
        ...
        av(t) {
            if (t < 3 && !this.St)
                return;
            if (0 === this.Op.width || 0 === this.Op.height)
                return;
            this.St = !1,
            this.Zp.applySuggestedBitmapSize();
            const i = rs(this.Zp, {
    ...
    class Ws {
        ...
        Dm(t, i) {
            ...
            for (const n of s)
                ys(i, (i => Cs(i, t, !1, void 0)), n, void 0);
            for (const n of s)
                ys(i, (i => Ps(i, t, !1, void 0)), n, void 0)
        }
        ov({context: t, bitmapSize: i}) {
        ...
        Bm(t, i, s) {
            const n = this.Np.Ei(t, s)
              , e = n / 2
              , r = Math.floor(i - e) + .5;
            return r < 0 ? i += Math.abs(0 - r) : r + n > this.Op.width && (i -= Math.abs(this.Op.width - (r + n))),
            i
        }
        Em(t, i) {
            const s = this.Tm();
        ...
        xm() {
            const t = this.Dp.Qt()
              , i = t.N();
            i.leftPriceScale.visible || null === this.fm || (this.gm.removeChild(this.fm.Xf()),
            this.fm.m(),
            this.fm = null),
            i.rightPriceScale.visible || null === this.pm || (this.Mm.removeChild(this.pm.Xf()),
            this.pm.m(),
            this.pm = null);
            const s = {
                Ec: this.Dp.Qt().Ec()
              ...
              , e = () => t.Wc();
            i.leftPriceScale.visible && null === this.fm && (this.fm = new As("left",i,s,n,e),
            this.gm.appendChild(this.fm.Xf())),
            i.rightPriceScale.visible && null === this.pm && (this.pm = new As("right",i,s,n,e),
    ...
    class Hs {
        ...
        hw() {
            null !== this.Wm && (this.nw(this.Wm, performance.now()),
            this.Wm = null);
        ...
        cw(t) {
            this.Um = t,
            this.Um ? this.tp().style.setProperty("cursor", t) : this.tp().style.removeProperty("cursor")
        }
        dw() {
            return this.Um
        }
        ...
        rw(t) {
            (void 0 !== t.autoSize || !this.Hm || void 0 === t.width && void 0 === t.height) && (t.autoSize && !this.Hm && this.Zm(),
            !1 === t.autoSize && null !== this.Hm && this.sw(),
            t.autoSize || void 0 === t.width && void 0 === t.height || this.Gm(t.width || this.Mo, t.height || this.sl))
        }
        aw(t) {
            let i = 0
              , s = 0;
        ...
        pw() {
            ...
            for (let t = 0; t < this.Am.length; ++t) {
                ...
                let e = 0
                  , h = 0;
                h = t === this.Am.length - 1 ? Math.ceil((c - f) * p) / p : Math.round(n.Vo() * d * p) / p,
                e = Math.max(h, 2),
                f += e,
                n.rv(Qi({
                    width: r,
        ...
        qm(t) {
            if (!(0 !== t.deltaX && this.Ps.handleScroll.mouseWheel || 0 !== t.deltaY && this.Ps.handleScale.mouseWheel))
                return;
            const i = this.mw(t)
              , s = i * t.deltaX / 100
              , n = -i * t.deltaY / 100;
        ...
        Jm() {
            ...
            for (let n = s; n < i; n++) {
                ...
                if (i.Kv().i(this.bw.bind(this, i), this),
                i.Xv().i(this.xw.bind(this, i), this),
                this.Am.push(i),
                n > 0) {
                    const t = new ms(this,n - 1,n);
                    this.zm.push(t),
                    this.$m.insertBefore(t.Xf(), this.Xm.Xf())
                }
        ...
        Km(t, i, s) {
            this.cw(this.Qt().hc()?.h_ ?? null),
            this.Ku.p(( () => this.Sw(t, i, s)))
        }
        Qm() {
    ...
    function qs(t, i, s, n) {
        ...
        return void 0 !== s.color && (r.R = s.color),
        r
    }
    function Ys(t, i, s, n) {
        const e = s.value
        ...
        return void 0 !== s.lineColor && (r.vt = s.lineColor),
    ...
    function Ks(t, i, s, n) {
        ...
        return void 0 !== s.topLineColor && (r.gr = s.topLineColor),
    ...
    function Xs(t, i, s, n) {
        ...
        return void 0 !== s.color && (e.R = s.color),
        e
    }
    function Zs(t, i, s, n) {
        const e = {
    ...
    function Qs(t, i) {
        return void 0 !== i.customValues && (t.Vw = i.customValues),
        t
    }
    function tn(t) {
    ...
    class hn {
        ...
        Ww(t, i) {
            ...
            if (void 0 !== e)
                if (1 === this.Ow.size)
                    ...
                    for (const i of this.Nw)
                        i.pointData.Bw.delete(t) && (n = !0);
            let r = [];
            if (0 !== i.length) {
        ...
        qw(t, i, s) {
            ...
            const a = void 0 === h;
            void 0 === h && (h = nn(e),
            this.zw.set(this.o_.key(e), h));
            const l = sn(t.Rr())
              , o = t.da()
              , _ = t.pa()
              , u = l(e, h.Re, i, n.Pw, o, _);
            h.Bw.set(t, u),
            s ? this.Yw(t, u, h.Re) : this.Kw(t, u);
            const c = {
                zh: Js(u),
                jw: s
            };
            ...
            for (let t = f; t < this.Nw.length; ++t)
                an(this.Nw[t].pointData, t);
            return this.o_.fillWeightsForPoints(this.Nw, f),
            this.$w(t, f, c)
        }
        Kw(t, i) {
            let s = this.Ow.get(t);
            ...
            null === n || this.o_.key(i.wt) > this.o_.key(n.wt) ? Js(i) && s.push(i) : Js(i) ? s[s.length - 1] = i : s.splice(-1, 1),
            this.Lw.set(t, i.wt)
        }
        Yw(t, i, s) {
        ...
        Hw(t, i) {
            0 !== i.length ? (this.Ow.set(t, i.filter(Js)),
            this.Lw.set(t, i[i.length - 1].wt)) : (this.Ow.delete(t),
            this.Lw.delete(t))
        }
        Fw() {
        ...
        Uw(t) {
            ...
            for (let s = 0; s < this.Nw.length && s < t.length; ++s) {
                ...
                e.timeWeight = n.timeWeight,
                an(e.pointData, s)
            }
            if (-1 === i && this.Nw.length !== t.length && (i = Math.min(this.Nw.length, t.length)),
            -1 === i)
                return -1;
            for (let s = i; s < t.length; ++s)
                an(t[s].pointData, s);
            return this.o_.fillWeightsForPoints(t, i),
            this.Nw = t,
            i
        }
        Xw() {
    ...
    function _n(t, i, s) {
        ...
        let a = r
          , l = h;
        return r > 0 && r < t.length && t[r].wt >= n && (a = r - 1),
    ...
    class un {
        ...
        Tt() {
            return this.Jn.Et() ? (this.rg(),
            null === this.ng ? null : this.hg) : null
        }
        ag() {
        ...
        _g() {
            ...
            if (0 === this.Jn.Xs().zr())
                return;
            const n = this.Jn.zt();
            null !== n && (this.ng = _n(this.sg, s, this.eg),
            this.ug(t, i, n.Ft),
            this.cg())
        }
    }
    ...
    function mn(t) {
        ...
        return void 0 !== t.Vw && (i.customValues = t.Vw),
        i
    }
    function wn(t) {
        const i = mn(t);
        return void 0 !== t.R && (i.color = t.R),
        i
    }
    function gn(t) {
        const i = mn(t);
        return void 0 !== t.vt && (i.lineColor = t.vt),
    ...
    function Mn(t) {
        const i = mn(t);
        return void 0 !== t.gr && (i.topLineColor = t.gr),
    ...
    class Bn {
        ...
        moveTo(t) {
            ...
            i !== t && (r(t >= 0 && t < this.Ff.Uf().length, "Invalid pane index"),
            this.Ff.Qt().mc(i, t))
        }
        getSeries() {
    ...
    class zn {
        ...
        barsInLogicalRange(t) {
            ...
            return null !== n && null !== e && (l.from = n.Pw,
            l.to = e.Pw),
            l
        }
        setData(t) {
            this.o_,
            this.Jn.Rr(),
            this.bg.Cg(this.Jn, t),
            this.Pg("full")
        }
        update(t, i=!1) {
            this.Jn.Rr(),
            this.bg.yg(this.Jn, t, i),
            this.Pg("update")
        }
        dataByIndex(t, i) {
    ...
    class Wn {
        ...
        $g(t) {
            let i = this.$u.get(t);
            return i || (i = new Bn(this.Ff,(t => this.jg(t)),t,this),
            this.$u.set(t, i)),
            i
        }
    }
    function Fn(t) {
        if (d(t)) {
            ...
            return r(null !== i, `Cannot find element in DOM with id=${t}`),
            i
        }
        return t
    }
    ...
    function $n(t, i, s, n, e, r, h) {
        if (0 === i.length || n.from >= i.length || n.to <= 0)
            return;
    ...
    class ie {
        ...
        fillWeightsForPoints(t, i) {
            for (let n = i; n < t.length; ++n)
                t[n].timeWeight = (s = t[n].time) % 120 == 0 ? 10 : s % 60 == 0 ? 9 : s % 36 == 0 ? 8 : s % 12 == 0 ? 7 : s % 6 == 0 ? 6 : s % 3 == 0 ? 5 : s % 1 == 0 ? 4 : 0;
            var s;
            this.tM = t[t.length - 1].time,
            this.Qg()
        }
        sM(t) {
    ...
    class ee extends Wn {
        ...
        _initWhitespaceSeries() {
            ...
            function n(n) {
                ...
                r !== s && (s = r,
                i.setData(function({le: t, oe: i, nM: s}) {
                    return Array.from({
    ...
    class he {
        ...
        fillWeightsForPoints(t, i) {
            for (let n = i; n < t.length; ++n)
                t[n].timeWeight = (s = t[n].time) === 100 * Math.ceil(s / 100) ? 8 : s === 50 * Math.ceil(s / 50) ? 7 : s === 25 * Math.ceil(s / 25) ? 6 : s === 10 * Math.ceil(s / 10) ? 5 : s === 5 * Math.ceil(s / 5) ? 4 : s === Math.ceil(s) ? 3 : 2 * s === Math.ceil(2 * s) ? 1 : 0;
            var s
        }
        Cn() {
    ...
    class ce extends Un {
        ...
        cg() {
            ...
            const i = this.Jn.N()
              ...
              , n = this.Qn.It().vu();
            if (null === this.ng || 0 === this.sg.length)
                return;
            let e, r;
            if (i.relativeGradient) {
                e = this.sg[this.ng.from].ut,
                r = this.sg[this.ng.from].ut;
    ...
    class be extends P {
        ...
        RM(t, i, s) {
            ...
            for (let t = s.from; t < s.to; t++) {
                ...
                f = Math.min(f, p));
                const v = p - f + 1;
                n.fillRect(f, c, v, _ - c),
                n.fillRect(f, u + 1, v, d - u),
                o = p
            }
        }
        DM(t) {
    ...
    class De {
        ...
        NM(t, i) {
            ...
            let n = s.get(i);
            return void 0 === n && (n = t.measureText(i).width,
            s.set(i, n)),
            n
        }
        FM(t) {
    ...
    class Le {
        ...
        draw(t) {
            t.useMediaCoordinateSpace((t => {
                ...
                s && this.qt.jM && (i.globalAlpha = this.qt.alpha ?? 1,
        ...
        et({context: t, horizontalPixelRatio: i, verticalPixelRatio: s}) {
            if (null !== this.qt && null !== this.qt.lt) {
                ...
                for (let n = this.qt.lt.from; n < this.qt.lt.to; n++) {
                    ...
                    void 0 !== e.ri && (e.ri.Qi = this.Ln.Ei(t, e.ri.lb),
                    e.ri.$t = this.W,
    ...
    function Qe(t, i, s, n) {
        i.fillStyle = t.R,
        void 0 !== t.ri && function(t, i, s, n, e, r) {
            t.save(),
            t.scale(e, r),
            t.fillText(i, s, n),
            t.restore()
    ...
    function sr(t, i, s, n, e, r, h, l) {
        const o = function(t, i) {
            if (ir(i.position) && void 0 !== i.price)
                return i.price;
            if ("value"in (s = t) && "number" == typeof s.value)
                return t.value;
            var s;
            if (function(t) {
        ...
        case "inBar":
        case "atPriceMiddle":
            return t.ut = a(h.priceToCoordinate(o)),
            void (void 0 !== t.ri && (t.ri.ut = t.ut + p + r + .6 * e));
        case "aboveBar":
        case "atPriceTop":
            {
                const i = _ ? 0 : n._b;
                return t.ut = a(h.priceToCoordinate(o)) - p - i,
                void 0 !== t.ri && (t.ri.ut = t.ut - p - .6 * e,
                n._b += 1.2 * e),
                void (_ || (n._b += f + r))
            }
        case "belowBar":
        case "atPriceBottom":
            {
                const i = _ ? 0 : n.ub;
                return t.ut = a(h.priceToCoordinate(o)) + p + i,
                void 0 !== t.ri && (t.ri.ut = t.ut + p + r + .6 * e,
                n.ub += 1.2 * e),
                void (_ || (n.ub += f + r))
            }
        }
    ...
    class nr {
        ...
        renderer() {
            if (!this.ge.options().visible)
                return null;
            this.St && this.pb();
            const t = this.Dp.options().layout;
            return this.Gt.Nn(t.fontSize, t.fontFamily, this.Ps.zOrder),
            this.Gt.ht(this.qt),
            this.Gt
        }
        mb(t) {
        ...
        pb() {
            ...
            if (null === this.ge.data()[0])
                return;
            if (0 === this.qt.ot.length)
                return;
            let r = NaN;
            ...
            for (let n = this.qt.lt.from; n < this.qt.lt.to; n++) {
                ...
                void 0 !== e.text && e.text.length > 0 && (o.ri = {
                    lb: e.text,
                    _t: 0,
                    ut: 0,
                    Qi: 0,
    ...
    class rr {
        ...
        Eb() {
            return null === this.Cb && (this.Cb = this.cb.reduce(( (t, i) => (t[i.position] || (t[i.position] = !0),
            t)), {
                inBar: !1,
                aboveBar: !1,
                belowBar: !1,
        ...
        draw(t) {
            t.useBitmapCoordinateSpace((t => {
                ...
                this.qt.forEach((e => {
                    ...
                    i.fill(),
                    e.jb && (i.strokeStyle = h,
                    i.lineWidth = Math.floor(2 * t.horizontalPixelRatio),
                    i.beginPath(),
                    i.moveTo((e._t - 4.7) * t.horizontalPixelRatio + s, (e.ut - 7 * e.jb) * t.verticalPixelRatio),
                    i.lineTo(e._t * t.horizontalPixelRatio + s, (e.ut - 7 * e.jb - 7 * e.jb * .5) * t.verticalPixelRatio),
                    i.lineTo((e._t + 4.7) * t.horizontalPixelRatio + s, (e.ut - 7 * e.jb) * t.verticalPixelRatio),
                    i.stroke())
                }
                ))
            }
